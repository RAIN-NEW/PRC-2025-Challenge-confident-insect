...
"""
Add Airspeed Components with ERA5 Data (Multi-Core Parallel Version) for Training Data.
...
# Assumes script is at: confident-insect/src/preprocessing/train/03_add_airspeed.py
...
INPUT_ROOT = project_root / "data" / "intermediate" / "02_build_script" / "train"
OUTPUT_ROOT = project_root / "data" / "intermediate" / "03_add_airspeed" / "train"
WEATHER_ROOT = project_root / "data" / "intermediate" / "climate_datasets" / "era5_train"
...
def parse_args():
    ap = argparse.ArgumentParser(description="Add ERA5 wind and airspeed components to training samples.")
