...
"""
Parallel Feature Engineering for Aircraft Samples (Final Data).
...
Input: Parquet files from '03_add_airspeed' step (Final dataset).
Output: Final processed samples ready for model inference.
"""
...
# Assumes script is at: confident-insect/src/preprocessing/final/04_add_advanced_features.py
...
DEFAULT_SRC = project_root / "data" / "intermediate" / "03_add_airspeed" / "final"
DEFAULT_DST = project_root / "data" / "intermediate" / "04_add_advanced_features" / "final"
...
def parse_args():
    ap = argparse.ArgumentParser(description="Parallel Feature Engineering for Final Samples (with Energy)")
