...
"""
Add Airspeed Components with ERA5 Data (Multi-Core Parallel Version) for Final Data.
...
# Assumes script is at: confident-insect/src/preprocessing/final/03_add_airspeed.py
...
INPUT_ROOT = project_root / "data" / "intermediate" / "02_build_script" / "final"
OUTPUT_ROOT = project_root / "data" / "intermediate" / "03_add_airspeed" / "final"
WEATHER_ROOT = project_root / "data" / "intermediate" / "climate_datasets" / "era5_final"
...
def parse_args():
    ap = argparse.ArgumentParser(description="Add ERA5 wind and airspeed components to final samples.")
