...
"""
Repair a single PRC-2025 trajectory parquet (Final Dataset) and write to the output directory.
...
def parse_args():
    ap = argparse.ArgumentParser(description="Batch repair trajectory Parquet files (Final Dataset).")
    
    # Dynamically locate project root
    # Assumes script is at: confident-insect/src/preprocessing/final/01_complement_data.py
    ...
    # Adjusted for FINAL dataset: flights_final
    default_input = project_root / "data" / "raw" / "prc-2025-datasets" / "flights_final"
    
    # Output path structure
    default_output = project_root / "data" / "intermediate" / "01_complement_data" / "flights_final"
