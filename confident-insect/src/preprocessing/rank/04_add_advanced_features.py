...
"""
Parallel Feature Engineering for Aircraft Samples (Rank Data).
...
Input: Parquet files from '03_add_airspeed' step (Rank dataset).
...
# Assumes script is at: confident-insect/src/preprocessing/rank/04_add_advanced_features.py
...
DEFAULT_SRC = project_root / "data" / "intermediate" / "03_add_airspeed" / "rank"
DEFAULT_DST = project_root / "data" / "intermediate" / "04_add_advanced_features" / "rank"
...
def parse_args():
    ap = argparse.ArgumentParser(description="Parallel Feature Engineering for Rank Samples (with Energy)")
